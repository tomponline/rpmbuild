...
%ifarch i686
# 32-bit kernel-llt, headers, perf & tools.
...
%ifarch x86_64
# 64-bit kernel-llt, headers, perf & tools.
%define with_doc 0
%endif
...
Name: kernel-llt
Summary: The Linux kernel latest longterm. (The core of any Linux-based operating system.)
...
# isn't required for the kernel-llt proper to function.
AutoReq: no
AutoProv: yes

#
# List the packages used during the kernel-llt build.
#
