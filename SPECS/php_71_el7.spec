...
BuildRequires: libmcrypt-devel, libxslt-devel, krb5-devel, libexif-devel
...
install -m 755 .libs/libphp7.so $RPM_BUILD_ROOT%{_libdir}/httpd/modules/

# Apache config fragment
install -m 755 -d $RPM_BUILD_ROOT/etc/httpd/conf.d
install -m 644 $RPM_SOURCE_DIR/php7.conf $RPM_BUILD_ROOT/etc/httpd/conf.d/php.conf
